      ...
      <div class="container">
        ...
        <img style="width:50%;z-index:-2" src="~/assets/plus_line.svg" alt="plus">
              ...
              <div class="cards-holder">
                ...
                <Card :green="true" :long="true" :iconData="'heart'" :titleData="'Marketing des médias sociaux'" :textData="'Notre équipe conçoit et développe des compagnes publicitaires efficaces et engageantes pour nos clients sur les réseaux sociaux afin.'"/>
